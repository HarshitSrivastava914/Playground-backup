...
import {
  ...
  setCardFormData,
  CardFormData,
} from "../services/paymentData"; // ✅ global formData import

interface PaymentFormProps {
  onSubmit: (data: CardFormData) => void;
  selectedCheckout: string; // to know if it's "Standard Checkout" or others
}
...
const CardPaymentForm: React.FC<PaymentFormProps> = ({
  ...
  // ✅ Initialize local copy from global data
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // ✅ Submit the current form data (global + local are synced)
    ...
    <div className="flex justify-center items-center bg-[#121212] min-h-screen p-5">
      ...
      >
        ...
        <input
          ...
          className="p-3 rounded border border-gray-600 bg-[#2a2a2a] text-white placeholder-gray-400"
          required
        />
        ...
        {/* Show card fields only for Custom/S2S Checkout */}
        {!isStandard && (
          <>
            <input
              type="text"
            ...
            <div className="flex gap-2">
              <input
                ...
                onChange={handleChange}
                className="w-1/3 p-2 rounded border border-gray-600 bg-[#2a2a2a] text-white placeholder-gray-400"
                required
              />
              <input
                type="text"
        ...
        <button
          type="submit"
          className="p-3 rounded bg-blue-600 hover:bg-blue-700 text-white font-medium transition"
        >
          Pay Now
        </button>
      </form>
